 ...
 * java -classpath kafka-producer-0.0.1.0.jar producer.KafkaFootballTicketsTRX localhost:9092 10
 *
 * @author Marcel Daeppen
 * @version 2021/08/07 14:28
 */

public class KafkaFootballTicketsTRX {
    ...
    private static Producer<String, byte[]> createProducer() {
        ...
        config.put(ProducerConfig.CLIENT_ID_CONFIG, "Feeder-Football-Tickets-Shop-TRX");
    ...
    private static void publishMessage(Producer<String, byte[]> producer) throws Exception {
        ...
        ProducerRecord<String, byte[]> eventrecord = new ProducerRecord<>("FootballTicketsTRX", key, valueJson);
    ...
    private static ObjectNode jsonObject() {
        ...
        switch (i) {
            ...
            case 5:
            case 6:
                report.put(gameName, "Arsenal - Olympiakos");
                break;
            case 1:
            case 7:
            case 8:
            case 9:
            case 10:
                report.put(gameName, "Milan - Man United");
                break;
            case 2:
            case 11:
                report.put(gameName, "Young Boys - Ajax");
                break;
            case 3:
                report.put(gameName, "Rangers - Slavia Prag");
                break;
            case 4:
            case 12:
            case 13:
            ...
            case 15:
            case 16:
                report.put(gameName, "Villarreal - Dynamo Kyiv");
                break;
            default:
    ...
    public static void setsleeptime(long sleeptime) {
        producer.KafkaFootballTicketsTRX.sleeptime = sleeptime;
    }
}